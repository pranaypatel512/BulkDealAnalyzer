    ...
    <div className="min-h-screen bg-grid-pattern flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="card p-8">
          ...
          {/* Messages */}
          {message && (
            <div className="mb-6 p-3 rounded-lg bg-[#00d4aa]/10 border border-[#00d4aa]/30 text-[#00d4aa] text-sm">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-[#00d4aa] hover:text-[#00b894] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <div className="mt-6 text-center">
            <p className="text-[var(--color-text-secondary)] text-sm">
              ...
              <Link href="/signup" className="text-[#00d4aa] hover:text-[#00b894] font-medium transition-colors">
                Sign up for free
              </Link>
            </p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[var(--color-bg-secondary)] text-[var(--color-text-muted)]">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-[var(--color-border)] hover:border-[var(--color-border-hover)] hover:bg-[var(--color-bg-tertiary)] transition-all"
            >
