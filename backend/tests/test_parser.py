...
class TestParseCSVContent:
    ...
    def test_parse_csv_content_valid(self):
        ...
        csv_content = """Date,Symbol,Client Name,Buy / Sell,Quantity Traded,Trade Price / Wght. Avg. Price
...
INVALID,DATA,HERE,WRONG,abc,xyz"""
    ...
    def test_parse_nse_format_headers(self):
        ...
        csv_content = '''DATE,SYMBOL,CLIENT NAME,BUY/SELL,QUANTITY TRADED,TRADE PRICE/ WEIGHTED. AVG. PRICE
02-Jan-2026,RELIANCE,ABC SECURITIES,BUY,50000,2450.75'''
...
class TestFilters:
    ...
    def sample_deals(self):
        ...
        return [
            BulkDeal(date="02-Jan-2026", symbol="RELIANCE", client_name="A", deal_type="BUY", quantity=50000, price=2450.75),
            BulkDeal(date="02-Jan-2026", symbol="TCS", client_name="B", deal_type="SELL", quantity=75000, price=3875.50),
            BulkDeal(date="02-Jan-2026", symbol="INFY", client_name="C", deal_type="BUY", quantity=100000, price=1825.25),
            BulkDeal(date="02-Jan-2026", symbol="RELIANCE", client_name="D", deal_type="SELL", quantity=25000, price=2460.00),
        ]
...
class TestSorting:
    ...
    def sample_deals(self):
        """Create sample deals for testing."""
        return [
            BulkDeal(date="02-Jan-2026", symbol="A", client_name="A", deal_type="BUY", quantity=50000, price=100.00),
            BulkDeal(date="02-Jan-2026", symbol="B", client_name="B", deal_type="BUY", quantity=100000, price=50.00),
            BulkDeal(date="02-Jan-2026", symbol="C", client_name="C", deal_type="BUY", quantity=25000, price=200.00),
        ]
